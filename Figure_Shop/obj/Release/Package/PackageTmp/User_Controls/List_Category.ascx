    ...
    <div class="category_list">
        <asp:DataList ID="DataList1" runat="server" Width="100%">
            <ItemTemplate>
                ...
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "../Pages/Product.aspx?ma_loai=" + Eval("ma_loai") %>' Text='<%# Eval("ten_loai") %>' CssClass='<%# "category" + (Request.QueryString["ma_loai"] != null && Request.QueryString["ma_loai"].ToString() == Eval("ma_loai").ToString() ? " active" : "") %>'></asp:HyperLink>
            </ItemTemplate>
        </asp:DataList>
    </div>
</div>
